...
import de.hhu.propra.spring.Application;
...
public class EndToEnd {
    ...
    void test1() throws IOException {
        ...
        assertThat(klausurDaten).contains("Betriebssysteme und Systemprogrammierung", "2022-03-28, 10:30 Uhr - 11:00 Uhr", "10:00 Uhr - 11:00 Uhr");
        assertThat(urlaubDaten).contains("3000-03-17", "10:15", "11:00");
        assertThat(click.getUrl().toString()).isEqualTo("http://localhost:8080/student/urlaubanmeldung");
        assertThat(click1.getUrl().toString()).isEqualTo("http://localhost:8080/student/klausuranmeldung");
    }
    ...
    void test2() throws IOException {
        ...
        //post
        HtmlPage redirectErgebnis = urlaubAnmeldung.getFormByName("urlaub_anmelden").getButtonByName("urlaubsanmeldung_abschicken").click();
    ...
    void test3() throws IOException {
        ...
        assertThat(redirectErgebnis.getUrl().toString()).isEqualTo("http://localhost:8080/student/urlaubanmeldung");
    ...
    void test4() throws IOException {
        ...
        //set online
        erstellungsPage.getElementById("online").setAttribute("value", String.valueOf(klausurDto.online()));
        //set datum
        ...
        //post
        HtmlPage redirectErgebnis = erstellungsPage.getFormByName("klausurform").getButtonByName("submitbtn").click();
    ...
    void test5() throws IOException {
        ...
        assertThat(redirectErgebnis.getUrl().toString()).isEqualTo("http://localhost:8080/student/klausurErstellen");
    ...
    void test6() throws IOException {
        ...
        HtmlPage redirection = page.getFormByName("klausur_anmelden").getButtonByName("klausuranmeldung_abschicken").click();
    ...
    void test7() throws IOException {
        ...
        assertThat(klausurDaten).contains("Betriebssysteme und Systemprogrammierung", "2022-03-28, 10:30 Uhr - 11:00 Uhr", "10:00 Uhr - 11:00 Uhr");
        assertThat(klausurDaten).doesNotContain("2022-03-29, 12:30 Uhr - 13:00 Uhr", "12:00 Uhr - 13:00 Uhr");
    }
