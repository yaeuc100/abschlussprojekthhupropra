...
public class StudentServiceHilfsmethodenTests {
  ...
  private Urlaub urlaub1 = new Urlaub(LocalDate.of(2022, 10, 10), LocalTime.of(9, 30),
      LocalTime.of(10, 30));
  private Urlaub urlaub2 = new Urlaub(LocalDate.of(2022, 10, 10), LocalTime.of(12, 30),
      LocalTime.of(13, 0));
  private Urlaub urlaub3 = new Urlaub(LocalDate.of(2022, 10, 11), LocalTime.of(9, 30),
      LocalTime.of(10, 30));
  private Urlaub urlaub4 = new Urlaub(LocalDate.of(2022, 9, 10), LocalTime.of(10, 30),
      LocalTime.of(11, 30));
  ...
  void test1() {
    ...
    //act
    List<Klausur> klausurenAnTag = studentServiceHilfsMethoden
        .studentHatKlausurAnTag(klausuren, datum);
  ...
  void test2() {
    ...
    //act
    List<Urlaub> ergebnis = studentServiceHilfsMethoden
        .findeUrlaubeAmSelbenTag(student, urlaub1.datum());
  ...
  void test4() {
    //arrange
    List<Urlaub> alte = List.of(urlaub1, urlaub2, urlaub3, urlaub4).stream()
  ...
  void test5() {
    ...
    List<Urlaub> neue = List.of(urlaub1, urlaub2, urlaub3, urlaub4).stream()
        .collect(Collectors.toList());
