...
public class UrlaubKlausurBearbeitungTests {
  ...
  void test3() {
    ...
    List<Urlaub> ergebnis = urlaubKlausurBearbeitung
        .reduziereUrlaubDurchKlausur(urlaub, freieZeitDurchKlausur);
  ...
  void test12() {
    ...
    //assert
    assertThat(ergebnis)
        .isEqualTo(List.of(reduzierterUrlaubVorKlausur, reduzierterUrlaubNachKlausur));
  }
  ...
  void test17() {
    ...
    //assert
    assertThat(ergebnis)
        .isEqualTo(List.of(reduzierterUrlaub, reduzierterUrlaub2, reduzierterUrlaub3));
  }
  ...
  void test23() {
    ...
    assertThat(ergebnis).isEqualTo(
        List.of(reduzierterUrlaub, reduzierterUrlaub2, reduzierterUrlaub3, reduzierterUrlaub4));
  }
  ...
  @Test
  @DisplayName(
      "Man versucht Urlaub für den gesamten Tag anzumelden, am Tag gibt es zwei Klausuren, " +
  ...
  void test26() {
    ...
    //act
    List<Urlaub> ergebnis = urlaubKlausurBearbeitung.
        reduziereUrlaubDurchMehrereKlausuren(
            List.of(beantragterUrlaub, beantragterUrlaub1, beantragterUrlaub2),
  ...
  void test27() {
    ...
    //assert
    assertThat(ergebnis)
        .isEqualTo(List.of(reduzierterUrlaub, reduzierterUrlaub1, reduzierterUrlaub2));
  }
