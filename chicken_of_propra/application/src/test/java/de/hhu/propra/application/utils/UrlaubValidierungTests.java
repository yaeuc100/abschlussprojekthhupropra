...
public class UrlaubValidierungTests {
  ...
  @Test
  @DisplayName("Zwei Urlaube an einem Tag dürfen nicht übereinander liegen")
  void test18() {
    //arrange
    Urlaub ersterUrlaub = new Urlaub(LocalDate.of(2001, 9, 11)
        , LocalTime.of(11, 30)
  ...
  @Test
  @DisplayName("Ein Urlaub ist nur bis einen Tag vorher eintragbar")
  void test6() {
    //arrange
    Urlaub urlaub = new Urlaub(LocalDate.of(2001, 9, 11),
        LocalTime.of(8, 30),
  ...
  void test67() {
    ...
    //act
    boolean ergebnis = urlaubValidierung.urlaubNurVorDemTagDesUrlaubsStornieren(urlaub);
    Set<String> fehler = urlaubValidierung.getFehlgeschlagen();

    //assert
    assertThat(ergebnis).isEqualTo(false);
    assertThat(fehler).contains(UrlaubFehler.STORNIERUNG_RECHTZEITIG);
    assertThat(fehler).hasSize(1);
  }
  ...
  @Test
  @DisplayName("Die Zeit von zwei Urlauben wird passend zusammengefügt")
  void test77() {
    //arrange
    Urlaub ersterUrlaub = new Urlaub(LocalDate.of(2001, 9, 11),
        LocalTime.of(12, 30),
    ...
    Urlaub zusammengefasst = new Urlaub(LocalDate.of(2001, 9, 11),
        LocalTime.of(11, 30),
        LocalTime.of(13, 30));

    //act
    Urlaub ergebnis = urlaubValidierung.fasseZeitZusammen(ersterUrlaub, zweiterUrlaub);

    //assert
    assertThat(ergebnis).isEqualTo(zusammengefasst);
  }
